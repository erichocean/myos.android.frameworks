    ...
    if (beenHere == NO) {
        ...
        if (beenHere == NO) {
            ...
            if (executablePath == nil || [executablePath length] == 0) {
                executablePath = [[[NSProcessInfo processInfo] arguments] objectAtIndex:0];
            }
            //printf("executablePath 2: %s", [executablePath cString]);
        ...
        [load_lock unlock];
        //printf("executablePath 4: %s", [executablePath cString]);

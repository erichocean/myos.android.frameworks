...
//    CGSize offset = CGSizeMake(10,10);
    ...
    CGPathAddArc(path, NULL, 50, 100, 25, 0, 2 * PI, YES);
    CGPathAddArc(path, NULL, 100, 200, 50, 0, 0.8 * PI, NO);
    CGPathAddArc(path, NULL, 200, 300, 50, 1.7 * PI, 1 * PI, NO);

    CGPathMoveToPoint(path, NULL, 200, 100);
    CGPathAddCurveToPoint(path, NULL, 200, 150, 300, 100, 350, 150);
    CGPathAddCurveToPoint(path, NULL, 201, 200, 310, 200, 320, 150);
    ...
    CGRect aRect = CGRectMake(100, 10, 150, 100);
    CGFloat radius = 10;
